                    ...
                    <div class="form-row">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('input_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('input_name', $obat->input_name) }}">
                                @error('input_name')
                        ...
                        <div class="form-group row mt-2">
                            <label for="tanggalInput" class="col-sm-3 col-form-label fw-semibold">Tanggal Input
                                :</label>
                            <div class="col-sm-9">
                                <input value="{{ old('input_date', $obat->input_date) }}" type="date"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('safety_stock') is-invalid @enderror"
                                    ...
                                    value="{{ old('safety_stock', $obat->safety_stock) }}">
                                @error('safety_stock')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
