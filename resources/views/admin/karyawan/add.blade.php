...
<x-main title="Tambah Karyawan">
    ...
    <div class="container">
        <div class="header">
            <h4 class="fw-bold">Tambah Karyawan</h4>
        </div>
        <div class="card">
            <div class="card-body p-4">
                ...
                @enderror
                <form id="form" method="POST" action="{{ route('admin.karyawan.insert') }}">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group row mt-2">
                            <label for="password" class="col-sm-3 col-form-label fw-semibold">Password
                                :</label>
                            <div class="col-sm-9">
